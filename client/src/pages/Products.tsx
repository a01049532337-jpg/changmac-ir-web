...
export default function Products() {
  ...
  const processFlow = [
    ...
    },
    {
      step: "2",
      title: "세척 및 건조",
      description: "불순물을 제거하고 완전히 건조하여 다음 공정을 위한 중단을 준비합니다."
    },
    {
      step: "3",
      title: "고급 전처리 공정",
      description: "단순 세척만으로는 부족한 불순물 제거를 위한 고급 전처리 공정을 실시합니다."
    },
    {
      step: "4",
      title: "화학적 순환 자원화",
    ...
    },
    {
      step: "5",
      title: "컴파운드 제조 및 펜릿화",
      description: "첫가제와 단단한 첫가를 제어하여 고품질 컴파운드를 제조하고 펜릿 형태로 생산합니다."
    },
    {
      step: "6",
      title: "품질 검사 및 포장",
