  ...
  const processFlow = [
    {
      step: "1",
      title: "폐플라스틱 수거 및 분류",
      description: "산업 현장과 소비자로부터 폐플라스틱을 수거하여 재질별로 정확히 분류합니다."
    },
    {
      step: "2",
      title: "세척 및 건조",
      description: "불순물을 제거하고 완전히 건조하여 품질을 보증합니다."
    },
    {
      step: "3",
      title: "분쇄 및 전처리",
      description: "적절한 크기로 분쇄하고 전처리 공정을 통해 가공성을 향상시킵니다."
    },
    {
      step: "4",
      title: "화학적 순환 자원화",
      description: "고급 기술을 통해 폐플라스틱을 화학적으로 분해하고 재구성합니다."
    },
    {
      step: "5",
      title: "컴파운딩 및 펠릿화",
      description: "첨가제를 혼합하여 고품질 컴파운드를 제조하고 펠릿 형태로 생산합니다."
    },
    {
      step: "6",
      title: "품질 검사 및 포장",
